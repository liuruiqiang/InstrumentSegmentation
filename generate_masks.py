...
if __name__ == '__main__':
    ...
    arg('--fold', type=int, default=3, choices=[0, 1, 2, 3, -1], help='-1: all folds')
    ...
    if args.fold == -1:
        ...
        model = get_model(str(Path(args.model_path).joinpath('model_{fold}raw42.pt'.format(fold=args.fold))),
                          model_type=args.model_type, problem_type=args.problem_type)
