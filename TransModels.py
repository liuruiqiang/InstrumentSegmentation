...
from Models.ViTViT import ViViT,Transformer,Transformer_fusion,Transformer_fusionv2
...
# # model = TeRAUNet_ViTFusion(3,3,h=320,w=256).cuda()
# model = MultiFrameFusionUNet11_ViTViT(3,3,h=320,w=256,numheads=4).cuda()
# # model = UNet11(3,3)
# # model.cuda()
# out = model(data)
# print(out.shape)
